  ...
  (t.prototype.respChart = function (r, a, e, n) {
    ...
    (t.prototype.initCharts = function () {
      ...
      if (0 < o("#task-area-chart").length) {
        var r = o("#task-area-chart").data("bgcolor"),
          a = o("#task-area-chart").data("bordercolor"),
          e = {
            labels: [
              "Sprint 1",
              "Sprint 2",
            ...
            datasets: [
              {
                label: "This year",
                backgroundColor: r || "#727cf5",
                borderColor: a || "#727cf5",
                data: [
                  16,
                  44,
                  32,
        ...
        t.push(
          this.respChart(o("#task-area-chart"), "Bar", e, {
      ...
      if (0 < o("#project-status-chart").length) {
        var n = o("#project-status-chart").data("colors"),
          i = {
        ...
        t.push(
          this.respChart(o("#project-status-chart"), "Doughnut", i, {
            maintainAspectRatio: !1,
            cutoutPercentage: 80,
            legend: { display: !1 },
          })
